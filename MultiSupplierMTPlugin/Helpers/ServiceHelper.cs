...
namespace MultiSupplierMTPlugin.Helpers
{
    ...
    class ServiceNames
    {
        ...
        public const string GatewayDesktop_LLM = nameof(GatewayDesktop_LLM);
    ...
    class ImplServiceFactories
    {
            ...
            = new Dictionary<string, Func<MultiSupplierMTOptions, ProviderOptions, MultiSupplierMTService>>
        {
            ...
            { ServiceNames.Anthropic_LLM, (mtOption, option) => new Providers.Anthropic.Service(mtOption, option) },
            {
                ...
                (mtOption, option) =>
                {
                    var service = new Providers.OpenAI.Service(mtOption, option);
                    service.UniqueName = ServiceNames.GatewayDesktop_LLM;
                    service.IsBatchSupported = true;
                    service.MaxSegments = 8;
                    service.MaxCharacters = 3000;
                    return service;
                }
            },
        };
